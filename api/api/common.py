...
def get_select_params(request, allowed_sort_by=[], default_page=1, default_page_size=10):
    sort_by = None
    if "sort_by" in request.args:
        sort_by = request.args.get("sort_by")
        if not sort_by in allowed_sort_by:
            sort_by = None
    ...
    return sort_by, results_page, results_page_size
